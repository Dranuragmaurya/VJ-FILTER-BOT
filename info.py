...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Anurag:Anurag@cluster0.9tlwy.mongodb.net/")   # IF Multiple Database Is False Then Fill Only This Database Url.
